...
namespace AiubLost_Found
{
    public partial class StuLog : Form
    {
        ...
        private void logbtn_Click(object sender, EventArgs e)
        {
            if (!Authenticate())
            {
                MessageBox.Show("Please enter both Student ID and Password.", "Login Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (count == 1)
                {
                    ...
                    StuLog.CurrentUserRole = "Student";
                ...
                {
                    MessageBox.Show("Invalid Student ID or Password.", "Login Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
